...
const playerGrid = [
  ...
  ['player2', 'col-start-1 col-end-4 row-start-4 row-end-7 flex items-center justify-end z-10 mb-40'],
  ...
  ['player5', 'col-start-7 col-end-10 row-start-4 row-end-7 flex items-center justify-center z-10 mb-40'],
